...
public class Persons {
	 ...
	 * <p>
	 * It selects a customer's details from the 'Project_Person_Details' table in the external 'PoisePMS' database by 
	 ...
	 * @param proj_num proj_num an integer entered by the user to locate a specific project object
	...
	public void displayCustomer(Statement statement, int proj_num) throws SQLException {
		...
		ResultSet results1 = statement.executeQuery("SELECT Name, Contact_Num, Physical_Address, Email_Address FROM Project_Person_Details WHERE Project_Num = " + proj_num
